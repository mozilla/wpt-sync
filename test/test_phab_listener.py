        ...
        with mock.patch("sync.tasks.handle.apply_async", mock_apply_async):
            ...
            assert events == [
                ('phabricator', {
                    ...
                    'text': ('mixedpuppy abandoned D53870: Bug 1593236 support more than one '
                ...
                ('phabricator', {
                    ...
                    'text': ('yzen created D55844: Bug 1599806 - remove setupInParent from '
                ...
                ('phabricator', {
                    ...
                    'text': ('sfink updated the diff for D55715: Bug 1596943 - DEBUG-only '
                ...
                ('phabricator', {
                    ...
                    'text': ("mak updated the diff for D55310: Bug 1600244 - Don't store "
                ...
                ('phabricator', {
                    ...
                    'text': ('ato closed D55177: bug 1590828: remote: return NS exceptions from '
                             'nsIRemoteAgent.'),
                    'epoch': 1575484597,
                ...
                ('phabricator', {
                    ...
                    'text': ('apavel closed D54914: Bug 1596314 - disable '
                ...
                ('phabricator', {
                    ...
                    'text': ('mattwoodrow closed D55568: Bug 1599662 - Add process '
                ...
                ('phabricator', {
                    ...
                    'text': ('sfink updated the diff for D55050: Bug 1597005 - Prevent '
